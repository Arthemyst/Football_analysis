...
from players.management.commands.prepare_data import MyException
...
def test_data_optimization_with_category_and_int_types(command):
    ...
    filepath = "./src/players/tests/fixtures/remove_gk.csv"
...
def test_read_csv_with_proper_amount_of_columns(command):
    ...
    filepath = "./fixtures/players_16.csv"
...
def test_save_good_file(tmp_path, command):
    ...
    filepath = "./fixtures/optimize_types.csv"
    df = pd.read_csv(filepath)
